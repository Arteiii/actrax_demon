...
public:
   ...
   * process.
   */
  [[nodiscard]] static auto InjectDll(DWORD processId,
...
private:
   ...
   */
  static auto OpenTargetProcess(DWORD processId) -> HANDLE;
   ...
   */
  static auto AllocateDllPath(HANDLE processHandle, const std::string& dllPath)
    -> LPVOID;
};
