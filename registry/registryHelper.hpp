...
public:
   ...
   */
  static auto RegGetDword(HKEY hKey,
   ...
   * @throws Error if the value cannot be read.
   */
  static auto RegGetString(HKEY hKey,
                           const std::wstring& subKey,
   ...
   * @throws Error if the value cannot be read.
   */
  static auto RegGetMultiString(HKEY hKey,
                                const std::wstring& subKey,
   ...
   */
  static auto RegEnumSubKeys(HKEY hKey, const std::wstring& subKey)
   ...
   */
  static auto RegEnumValues(HKEY hKey, const std::wstring& subKey)
    -> std::vector<std::pair<std::wstring, DWORD>>;
   ...
   */
  static auto RegSetDword(HKEY hKey,
                          const std::wstring& subKey,
                          const std::wstring& value,
                          DWORD data) -> void;
   ...
   * @throws Error if the value cannot be set.
   */
  static auto RegSetString(HKEY hKey,
                           const std::wstring& subKey,
                           const std::wstring& value,
   ...
   * @throws Error if the value cannot be set.
   */
  static auto RegSetMultiString(HKEY hKey,
                                const std::wstring& subKey,
                                const std::wstring& value,
