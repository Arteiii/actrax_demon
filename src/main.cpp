#include "modules/ApplicationController/ApplicationController.hpp"
#include "modules/RegistryManager/RegistryManager.hpp"
#include "modules/System/SystemInfo.hpp"

#include "modules/System/SystemManager.hpp"
#include "modules/Utility/Utility.hpp"
                   ...
                   const std::shared_ptr<std::string>& clientId) -> void
{
  ...
  System::SaveTokensToFile(Utility::ConvertToWString(*newRefreshToken),
                           Utility::ConvertToWString(*clientId));
